...
import com.github.skozlov.math.algebra.operation_properties.id.{Id, LeftId, RightId}
import com.github.skozlov.math.algebra.operation_properties.inversion.{FullInversion, NonZeroInversion, PartialInversion}
